...
var ERROR_MAP = (dist_index_esm_a = {},
    ...
    dist_index_esm_a);
var errorFactory = new util_dist_index_cjs["ErrorFactory"]('messaging', 'Messaging', ERROR_MAP);
...
var index_esm_SubscriptionManager = /** @class */ (function () {
    ...
    SubscriptionManager.prototype.getToken = function (services, subscription, vapidKey) {
        return Object(tslib_es6["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib_es6["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_esm_getHeaders(services)];
                    case 1:
                        headers = _a.sent();
...
var index_esm_BaseController = /** @class */ (function () {
    function BaseController(services) {
        ...
        this.tokenDetailsModel = new index_esm_TokenDetailsModel(services);
    }
...
var index_esm_WindowController = /** @class */ (function (_super) {
    ...
    function WindowController(services) {
        ...
        _this.onMessageInternal = Object(util_dist_index_cjs["createSubscribe"])(function (observer) {
            _this.messageObserver = observer;
        });
        _this.onTokenRefreshInternal = Object(util_dist_index_cjs["createSubscribe"])(function (observer) {
    ...
    WindowController.prototype.setupSWMessageListener_ = function () {
        var _this = this;
        navigator.serviceWorker.addEventListener('message', function (event) { return Object(tslib_es6["__awaiter"])(_this, void 0, void 0, function () {
...
var dist_index_esm_name = "@firebase/messaging";
...
function registerMessaging(instance) {
    ...
    var factoryMethod = function (container) {
        ...
        if (self && 'ServiceWorkerGlobalScope' in self) {
            ...
            return new index_esm_SwController(firebaseServices);
        }
        else {
            // Assume we are in the window context.
            return new index_esm_WindowController(firebaseServices);
        }
    };
    var namespaceExports = {
        isSupported: isSupported
    };
    instance.INTERNAL.registerComponent(new dist_index_cjs["Component"](messagingName, factoryMethod, "PUBLIC" /* PUBLIC */).setServiceProps(namespaceExports));
